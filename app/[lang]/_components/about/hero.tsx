      ...
      <div className='relative z-10 mx-auto h-full max-w-screen-xl px-4 pt-20 pb-8 md:pr-[34vw] md:pb-20'>
        <div className='space-y-6'>
          ...
          <div className='space-y-4'>
            ...
            <p>
              {dict.p4} <strong>{dict.p4Bold} </strong> {dict.p4Rest}
            </p>
          </div>
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        height={logo.h}
        className={clsx(
          'object-contain duration-300 group-hover:scale-105 motion-safe:transition-all',
          mobile ? 'max-h-10 sm:max-h-12' : 'max-h-12 lg:max-h-14',
          imageLoaded ? 'opacity-100' : 'opacity-0'
        )}
