...
function GalleryImageItem({
  ...
  return (
    <div
      className={clsx(
        'group relative aspect-[4/3] overflow-hidden rounded-lg bg-slate-100 ring-1 ring-slate-200 duration-300 motion-safe:transition-all',
        'hover:-translate-y-1 hover:shadow-lg hover:ring-2 hover:shadow-black/25 hover:ring-sky-300',
    ...
    >
      {image ? (
        <OptimizedCloudinaryImage
          ...
          quality={70}
          className='h-full w-full object-cover duration-500 group-hover:scale-110 motion-safe:transition-transform'
          loading='lazy'
        ...
        <div className='h-full w-full bg-slate-200 motion-safe:animate-pulse' />
      )}
      ...
      {/* Image info on hover */}
      <div className='absolute right-2 bottom-2 left-2 text-white opacity-0 duration-300 group-hover:opacity-100 motion-safe:transition-opacity'>
  ...
  return (
    <div className='flex justify-center py-8'>
      <button
        ...
        disabled={loading}
        className={clsx(
          'inline-flex items-center gap-3 rounded-full px-8 py-4 font-medium duration-200 motion-safe:transition-all',
      ...
      >
        {loading ? (
          <>
            <div className='h-5 w-5 rounded-full border-2 border-white border-t-transparent motion-safe:animate-spin' />
            {loadingMoreText}
          </>
        ) : (
          <>
    ...
    return (
      <div className='container mx-auto px-4 py-12'>
        <div className='text-center'>
          <div className='mx-auto h-12 w-12 rounded-full border-4 border-sky-500 border-t-transparent motion-safe:animate-spin' />
