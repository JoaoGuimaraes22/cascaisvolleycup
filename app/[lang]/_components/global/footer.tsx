        ...
        <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4'>
          <div className='sm:col-span-2 lg:col-span-1'>
            <Link
              ...
              className='inline-block rounded-sm hover:scale-105 focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:outline-none motion-safe:transition-transform'
            >
              <Image
                src={LOGO}
          ...
          <div>
            <h3 className='mb-4 text-sm font-semibold tracking-wider text-slate-800 uppercase'>
              {dict.quickLinks}
            </h3>
                ...
                {quickLinks.map(link => (
                  <li key={link.href}>
                    <Link
                      ...
                      className='text-sm text-slate-600 hover:text-sky-700 focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:outline-none motion-safe:transition-colors'
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className='lg:col-span-1'>
            ...
            <Link
              ...
              className='inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-sky-600 to-sky-700 px-4 py-2.5 text-sm font-semibold text-white shadow-sm ring-1 ring-black/10 hover:scale-105 hover:from-sky-700 hover:to-sky-800 hover:shadow-md focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:outline-none motion-safe:transition-all'
  ...
  if (href) {
    return (
      <a
        href={href}
        aria-label={label}
        className='block rounded-sm hover:text-sky-700 focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:outline-none motion-safe:transition-colors'
      >
        {content}
      </a>
    )
...
const SocialIcon: FC<{
  ...
  <a
    ...
    title={title}
    className='inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-sky-700 shadow-sm ring-1 ring-slate-300 hover:scale-105 hover:bg-sky-50 hover:text-sky-800 hover:shadow-md focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:outline-none motion-safe:transition-all'
...
const SponsorLogo: FC<{ sponsor: Sponsor }> = ({ sponsor }) => {
  ...
  if (sponsor.url) {
    return (
      <a
        ...
        target='_blank'
        rel='noopener noreferrer'
        className='block rounded-sm opacity-70 hover:opacity-100 focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:outline-none motion-safe:transition-opacity'
  ...
  return (
    <div className='opacity-70 hover:opacity-100 motion-safe:transition-opacity'>
      {logoElement}
    </div>
  )
}
