              ...
              >
                ...
                <div className='space-y-1'>
                  ...
                  <div className='rounded-lg bg-transparent p-4 shadow-sm'>
                    <div className='mb-2 flex flex-wrap items-baseline gap-2'>
                      <span className='font-extrabold tracking-wide text-sky-700 uppercase'>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='rounded-lg bg-transparent p-4 text-sm'>
                    <p className='font-bold text-sky-700 uppercase'>
                ...
                >
                  <a
                    ...
                    className='inline-flex items-center justify-center rounded-lg bg-sky-600 px-6 py-3 text-sm font-bold text-white shadow-lg duration-300 hover:scale-105 hover:bg-sky-700 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 motion-safe:transition-all'
                  >
                  ...
                  <button
                    ...
                    className='inline-flex items-center justify-center rounded-lg bg-sky-700 px-6 py-3 text-sm font-bold text-white shadow-lg duration-300 hover:scale-105 hover:bg-sky-800 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 motion-safe:transition-all'
                  >
...
function ContactOSportsButton({
  label,
  onOpenModal
}: ContactOSportsButtonProps) {
  return (
    <button
      onClick={onOpenModal}
      className='group inline-flex items-center gap-2 rounded-lg bg-sky-600 px-6 py-3 text-sm font-bold text-white shadow-lg duration-300 hover:scale-105 hover:bg-sky-700 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 motion-safe:transition-all'
    >
      <FiMail className='h-4 w-4 duration-300 group-hover:rotate-12 motion-safe:transition-transform' />
      <span>{label}</span>
    </button>
  )
}
