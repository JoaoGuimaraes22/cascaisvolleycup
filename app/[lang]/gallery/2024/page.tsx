...
export async function generateMetadata({
  ...
  return {
    title: `${gallery.title} 2024 | Cascais Cup`,
    description: `${gallery.description} 2024. View photos and highlights from the Cascais Cup 2024 volleyball tournament.`,
...
function generateStructuredData(lang: string) {
  return {
    ...
    url: `https://cascaisvolley.com/${lang}/gallery/2024`,
...
export default async function Gallery2024PageRoute({
  ...
  return (
    <>
      ...
      <Gallery
        year={2024}
        title={`${gallery.title} 2024`}
        description={`${gallery.yearDescription} 2024 - ${gallery.yearSubtitle} volleyball tournament in Cascais, Portugal.`}
        dict={gallery.Main}
      />
    </>
  );
